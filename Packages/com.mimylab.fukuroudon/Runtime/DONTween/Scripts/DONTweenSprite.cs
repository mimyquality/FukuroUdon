...
namespace MimyLab.FukuroUdon
{
    ...
    public class DONTweenSprite : DONTween
    {
        ...
        private void Initialize()
        {
            ...
            _isChangeColor = ((int)_changeProperty & (int)DONTweenGraphics.Color) > 0 && _targetSprite;
            _isChangeFade = ((int)_changeProperty & (int)DONTweenGraphics.Fade) > 0 && _targetSprite;
