...
- DON Tween Transform の Rotation に LoopType.Increment が機能しなかったのを修正しました。 [#58](https://github.com/mimyquality/FukuroUdon/issues/58)
...
- DON Tween Transform は Update Mode を選べるようになりました。

## [3.19.1] - 2026/6/24

**Fixed**  

- DON Tween Transform の Rotation の内部計算をクォータニオンにしました。
  - VRCTween が何故かオイラー角で計算しているので、ジンバルロックしたり変な周り方をする事がありました。
